...
#define pageContolWidth kDisWidth/4
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        pageControl=[[UIPageControl alloc] initWithFrame:CGRectMake((kDisWidth-pageContolWidth)/2, self.height - 30, pageContolWidth, 10.0)];
