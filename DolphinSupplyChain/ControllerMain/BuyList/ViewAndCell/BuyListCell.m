...
- (void)initView
{
    ...
    [self.imgNOInventory mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(self.imgBuy.mas_top).offset(20);
        make.left.equalTo(self.imgBuy.mas_left).offset(20);
        make.right.equalTo(self.imgBuy.mas_right).offset(-20);
        make.bottom.equalTo(self.imgBuy.mas_bottom).offset(-20);
    }];
