...
@interface BuyListScreenView () <UITableViewDelegate, UITableViewDataSource>
...
@property (nonatomic, strong) HTTabbleView *tbBrand;
...
@implementation BuyListScreenView
...
- (HTTabbleView *)tbBrand
{
    if (!_tbBrand) {
        _tbBrand = [[HTTabbleView alloc] initWithFrame:CGRectZero style:UITableViewStylePlain];
